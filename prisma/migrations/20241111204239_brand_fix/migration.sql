...
INSERT INTO "new_houseProduct" ("brand", "hasAlert", "houseId", "id", "minimum", "name", "productId", "quantity") SELECT coalesce("brand", '') AS "brand", "hasAlert", "houseId", "id", "minimum", "name", "productId", "quantity" FROM "houseProduct";
